...
namespace RepositoryLayer.Service
{
    public class AddressBookRL : IAddressBookRL
    {
        ...
        public async Task<ContactRequestModel> GetContactById(int id)
        {
            ...
            return _mapper.Map<ContactRequestModel>(contact);  // Convert ContactEntity to ContactRequestModel
        }

        public async Task<ContactEntity> AddContact(ContactRequestModel contact)
        {
            var newContact = _mapper.Map<ContactEntity>(contact);  // AutoMapper does the conversion
        ...
        public async Task<ContactRequestModel> DeleteContact(int id)
        {
            ...
            return _mapper.Map<ContactRequestModel>(contact);  // Convert ContactEntity → ContactRequestModel
        }
